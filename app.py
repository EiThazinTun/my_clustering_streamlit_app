...
#Set title
st.title(" k-Means Clustering Visualizer By Ei Thazin Tun_6531501207")
...
ax.scatter(loaded_model.cluster_centers_[:, 0], loaded_model.cluster_centers_[:, 1], s=300, c='red',s=200, alpha=0.75, marker='X', label='Centroids')
